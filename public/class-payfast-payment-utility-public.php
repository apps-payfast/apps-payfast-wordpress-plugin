...
class Payfast_Payment_Utility_Public {
    ...
    private $_payfastTokenUrl = 'https://ipguat.apps.net.pk/Ecommerce/api/Transaction/GetAccessToken?MERCHANT_ID=%s&SECURED_KEY=%s';
    private $_payfastWebcheckout = 'https://ipguat.apps.net.pk/Ecommerce/api/Transaction/PostTransaction';
